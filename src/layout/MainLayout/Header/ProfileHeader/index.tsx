...
export const ProfileHeader = () => {
  ...
  return (
    <>
      <Stack gap={1} flexDirection="row" alignItems="center" ref={anchorRef} sx={{ cursor: "pointer" }} onClick={() => {
        setOpen(!open);
      }}>
          ...
          <ClickAwayListener onClickAway={handleClickAway}>
            <List>
              ...
              >
                ...
                <ListItemText
                  primary={<Typography variant="h6">{t("profile")}</Typography>} />
              </ListItemButton>
              <ListItemButton
                sx={{ borderRadius: "10px" }}
              >
                ...
                <ListItemText
                  primary={<Typography variant="h6">{t("logout")}</Typography>} />
              </ListItemButton>
            </List>
          </ClickAwayListener>
        </Paper>
